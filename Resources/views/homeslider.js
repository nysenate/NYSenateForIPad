...
var feeds = [
['Newsroom','newsroom','senate_updates'],
...
var scrollViewMain = Titanium.UI.createScrollView({
			top:0,
			left:0,
			width:screenWidth,
			contentWidth:'auto',
			...
			if (thumbnail)
			{
				...
				img.addEventListener('singletap',function(e)
				{
					...
					var htmlData =  e.source.blogContent;
						...
						showHTMLContent(e.source.blogTitle,e.source.blogLink,htmlData,false,0,0,win.detailView);
...
function loadFeed (type, value, feedIdx)
{
	...
	else if (type == 'newsroom')
	{
			...
			doNYSenateServiceCall('views.get',['view_name'],[value],serviceCallback);
	}
